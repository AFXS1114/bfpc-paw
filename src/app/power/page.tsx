      ...
      <div className="flex-1 space-y-6 p-4 md:p-6">
        <Card className="shadow-lg">
          <CardHeader>
            ...
            <CardDescription>Enter the details from your power meter.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="reading-value">Meter Reading (kWh)</Label>
                <Input id="reading-value" type="number" placeholder="e.g., 12345" className="mt-1" />
              </div>
            </div>
            <div>
        ...
        <Card className="shadow-lg">
          <CardHeader>
            ...
            <CardDescription>View your past power readings and usage trends.</CardDescription>
          </CardHeader>
          <CardContent className="h-[300px] flex items-center justify-center bg-muted/30 rounded-md">
            ...
            />
            {/* <p className="text-muted-foreground">Power readings history chart/table will be here.</p> */}
          </CardContent>
        </Card>
      </div>
    </main>
