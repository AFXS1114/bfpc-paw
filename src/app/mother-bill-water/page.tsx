...
import { EditMotherBillModal } from "@/components/edit-mother-bill-modal";
...
export default function WaterMotherBillPage() {
  ...
  // Watch past and present readings to auto-calculate total consumption for water
  ...
  }, [pastReadingValue, presentReadingValue, setValue]);
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                       <FormItem>
                        ...
                        <FormControl>
                            <Input type="number" {...field} readOnly className="bg-muted/80 font-semibold" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
