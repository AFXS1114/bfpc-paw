...
import { Home, Settings, Droplet, Zap, BarChart3, LayoutDashboard, Users, ListTree, ReceiptText } from "lucide-react"; // Added ReceiptText
import { 
  SidebarMenu, 
  SidebarMenuItem, 
  SidebarMenuButton,
...
const navItems = [
  ...
  { href: "/mother-bill", label: "Mother Bill", icon: ReceiptText }, // Added Mother Bill Link
